...
(function(){
  var animator;
  window.animator = animator = function(){
    this.que = [];
    this.running = false;
  ...
  animator.prototype = import$(Object.create(Object.prototype), {
    bezier: function(t){
    ...
    animate: function(n, ve, dur){
      ...
      for (k in ve) {
        ...
        for (i$ = 0, len$ = (ref$ = animator.intorder).length; i$ < len$; ++i$) {
          t = ref$[i$];
          if (!(ret = animator.intparser[t](vs[k], ve[k]))) {
            continue;
          }
          tp[k] = t;
          break;
  ...
  if (typeof module != 'undefined' && module !== null) {
    return module.exports = animator;
  }
})();
